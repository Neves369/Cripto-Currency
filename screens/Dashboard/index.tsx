...
export default function Dashboard({ navigation }: RootTabScreenProps<'Dashboard'>) {
      ...
      return(
        ...
        >
          ...
          <View style={{flexDirection: 'row', backgroundColor: 'transparent'}}>
            ...
            <View style={{marginLeft: SIZES.base, backgroundColor: 'transparent'}}>
              <Text style={{...FONTS.h2}}>{item.currency}</Text>
              <Text style={{color: COLORS.gray, ...FONTS.body3}}>{item.code}</Text>
            </View>
          </View>

          <View style={{marginTop: SIZES.radius, backgroundColor: 'transparent'}}>
    ...
    return(
      ...
      >
        ...
        <Text style={{marginTop: SIZES.base, color: COLORS.white, ...FONTS.body4, lineHeight: 18}}>
          It's very difficult to time an investiment,
          especially when the market is volatile. Learn how to
          use dolar cost averaging to your advantage.
        </Text>
        <TouchableOpacity
          style={{
            marginTop: SIZES.base
  ...
  return (
    <ScrollView>
      ...
      <View style={{flex: 1, paddingBottom: 130, backgroundColor: 'transparent'}}>
        {renderHeader()}
        {renderAlert()}
        {renderNotice()}
      </View>
